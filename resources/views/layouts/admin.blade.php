                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white {{ Route::currentRouteName() == 'admin.projects.index' ? 'bg-secondary' : '' }}"
                                    ...
                                    <i class="fa-solid fa-tachometer-alt fa-lg fa-fw"></i> Portfolio
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white {{ Route::currentRouteName() == 'admin.projects.deleted' ? 'bg-secondary' : '' }}"
                                    href="{{ route('admin.projects.deleted') }}">
                                    <i class="fa-solid fa-tachometer-alt fa-lg fa-fw"></i> Trash
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white {{ Route::currentRouteName() == 'admin.types.index' ? 'bg-secondary' : '' }}"
                                    href="{{ route('admin.types.index') }}">
                                    <i class="fa-solid fa-tachometer-alt fa-lg fa-fw"></i> Project's Type
                                </a>
                            </li>
                            <li class="nav-item">
